...
import com.yan.interview.util.InterviewDocumentUtil;
import com.yan.interview.util.SchameDocumentUtil;
...
public class InterviewMongoDaoUtil {
	...
	public static void main(String[] args) throws Exception {
		...
		List<Interview> interviews = interviewMongoDaoUtil.findInterviewDocumentsByUserNameOrPhoneOrEmail("马晶晶", "18330215673", "295605043@qq.com");
	...
	public String insertInterview(Interview interview){
		...
		MongoCredential credential = MongoCredential.createCredential(user, "manage", pwd.toCharArray());
		...
		//Create a Document
		Document doc = InterviewDocumentUtil.interviewToDocument(interview);
	...
	public List<Interview> findInterviewDocumentsByUserNameOrPhoneOrEmail(String userName, String phone, String email){
		...
		if(docs != null){
			...
			for(Document doc : docs){
				...
				interview = InterviewDocumentUtil.documentToInterview(doc);
